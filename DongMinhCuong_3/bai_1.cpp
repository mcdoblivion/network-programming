...
int main()
{
    ...
    cout << "Enter file name length: ";
    cin >> temp;
    udphdrInstance.fileNameLength = (unsigned char)temp;
    ...
    fstream outputFile;
    outputFile.open("pkt_hdr.bin", ios::out | ios::binary);
    outputFile.write((char *)&udphdrInstance, sizeof(udphdrInstance));
    outputFile.close();
